...
- the age of the runner at the time of the race (assume `age` represents the runner's age in 2021) 
- the average minutes per mile that runner completed the race in
