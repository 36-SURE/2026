...
For instance, one of Sara's favorite themes is `theme_light()`:
...
and one of Erin's go-to themes is `theme_bw()`:
...
Finished early? We encourage you to work on a [TidyTuesday](https://github.com/rfordatascience/tidytuesday) visualization. TidyTuesday is a weekly social data project, organized by the [Data Science Learning Community](https://dslc.io). Every week a new dataset is posted along with some questions that could be interesting to explore. 

Feel free to use any dataset from the [TidyTuesday GitHub](https://github.com/rfordatascience/tidytuesday) that interests you (it doesn't have to be this week's data). For inspiration, you can check out [BlueSky's TidyTuesday posts](https://bsky.app/profile/did:plc:777eanw7giyjd76dwatpch3d/feed/aaajcyvxadl56). Another option would be to try to recreate someone else's visualization *without* looking at their source code. 

Some TidyTuesday compilations:[^1] 

- Steven Ponce's [Data Visualizations](https://stevenponce.netlify.app/data_visualizations.html)

- Nicola Rennie's [TidyTuesday](https://github.com/nrennie/tidytuesday)

- Carl Börstell's [TidyTuesday](https://github.com/borstell/tidytuesday/tree/main)

- Rajo's [TidyTuesday](https://github.com/rajodm/TidyTuesday/)

Note: Erin and Sara both did TidyTuesdays as undergraduates (see the bulleted links below). It was a great way to improve data visualization skills.

- [Erin's TidyTuesdays](https://efranke22.github.io/tidytuesday.html)

- [Sara's TidyTuesdays](https://scolando.github.io/notebooks/tidytuesday.html)


```{r}
#| eval: false
# example of how to load TidyTuesday data
# check out https://github.com/rfordatascience/tidytuesday for other datasets
...
[^1]: Thank you to [Jo Hardin](https://hardin47.github.io/TidyTuesday/) for compiling this list.
