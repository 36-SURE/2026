...
```{r}
roster <- list(
  name = c("Sara", "Erin", "Princess", "Yuchen", "JungHo"),
  role = c("Instructor", "Instructor", "TA", "TA", "TA"),
  is_TA = c(FALSE, FALSE, TRUE, TRUE, TRUE)
)
str(roster)
```
...
(FYI, Erin uses the *Tomorrow* theme and Sara uses the *Clouds* theme!)
