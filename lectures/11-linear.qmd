...
- Always make sure to interpret important coefficients in context (*and with units*)! 
...
*Example:* an interaction between `team` and `offense_ave_epa_pass` says that the association between passing performance and season score differential depends the NFL team
